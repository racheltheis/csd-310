...
def NewClients(cursor, title):
    ...
    cursor.execute("SELECT COUNT(*) AS client_count FROM clients WHERE registration_date >= DATE('2023-08-20') - INTERVAL 6 MONTH;")
...
num_of_bills(cursor, "6 month billing period")